...
int main() {
    int base, exponente, resultado = 1, i = 0; // Declaración de variables: base es la base de la potencia, exponente es el exponente, resultado almacenará el resultado de la potencia, i es un contador.

    // Leer la base y el exponente
    printf("Ingresa la base: "); // Imprimir mensaje solicitando al usuario ingresar la base.
    scanf("%d", &base); // Leer la base ingresada por el usuario y almacenarla en la variable base.
    ...
    do { // Inicio del bucle do-while que se ejecutará al menos una vez.
        ...
        do { // Bucle interno que se ejecuta mientras j sea menor que resultado.
            temp += base; // Sumar la base a temp.
    ...
    printf("El resultado de %d^%d es: %d\n", base, exponente, resultado); // Imprimir el resultado de la potencia.
